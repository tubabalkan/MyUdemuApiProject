        ...
        public async Task<IActionResult> Index(string cityId)
        {
            if (!string.IsNullOrEmpty(cityId))
            {
                ...
                var request = new HttpRequestMessage
                {
                    ...
                    RequestUri = new Uri($"https://booking-com.p.rapidapi.com/v2/hotels/search?children_number=2&locale=en-gb&children_ages=5%2C0&filter_by_currency=EUR&checkin_date=2024-09-14&categories_filter_ids=class%3A%3A2%2Cclass%3A%3A4%2Cfree_cancellation%3A%3A1&dest_type=city&dest_id={cityId}&adults_number=2&checkout_date=2024-09-17&order_by=popularity&include_adjacency=true&room_number=1&page_number=0&units=metric"),
                    Headers =
    {
